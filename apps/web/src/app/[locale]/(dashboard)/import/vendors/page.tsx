...
import { mockImportSourceConfigs, mockVendorImportReviewRecords } from '@/lib/mock-data';

const SOURCE_CONFIG = mockImportSourceConfigs.find(s => s.moduleType === 'vendors_import')!;

const INITIAL_RECORDS: ReviewRecord[] = mockVendorImportReviewRecords.map(r => ({
  id: r.id,
...
const COLUMNS: ColumnDef[] = [
  { key: 'name',          labelAr: 'الاسم', width: 200 },
  { key: 'phone',         labelAr: 'الهاتف', width: 120 },
  { key: 'email',         labelAr: 'البريد الإلكتروني', width: 180 },
  { key: 'city',          labelAr: 'المدينة', width: 110 },
  { key: 'tax_number',    labelAr: 'الرقم الضريبي', width: 150 },
  { key: 'payment_terms', labelAr: 'شروط الدفع', width: 110 },
];
  ...
  return (
    <>
      <div className="page-header">
        <div>
          <h2 className="page-title">استيراد الموردين</h2>
          <p className="page-subtitle">مراجعة واعتماد بيانات الموردين المستوردة من Google Sheets</p>
        </div>
